...
var DateTimePickerTime = createClass({
	...
	renderHeader: function () {
		...
		var customDateFormat = this.props.dateFormat.replace(/y/ig, '');
		var date = this.props.selectedDate || this.props.viewDate;
		var displayDate = this.props.buddishEra ? date.format(customDateFormat) + (parseInt(date.format('YYYY'), 10) + 543) : date.format(this.props.dateFormat);
		return React.createElement('thead', { key: 'h' }, React.createElement('tr', {},
			React.createElement('th', { className: 'rdtSwitch', colSpan: 4, onClick: this.props.showView('days') }, displayDate)
		));
	},
